...
if ( ! function_exists( 'hashtag_setup' ) ) :
	/**
	...
	function hashtag_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'hashtag' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'hashtag_custom_background_args', array(
...
function hashtag_scripts() {
	wp_enqueue_style( 'hashtag-style', get_stylesheet_uri() );

	wp_enqueue_script( 'hashtag-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'hashtag-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
